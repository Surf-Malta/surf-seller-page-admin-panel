            ...
            {setupChecklist.map((task, index) => (
              <div key={index} className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-blue-600">{task.description}</p>
                </div>
              </div>
            ))}
          </div>
            ...
            >
              ...
              {action.external ? (
                <a
                  ...
                  className={`inline-flex items-center px-3 py-2 text-sm font-medium text-white rounded-md transition-colors ${action.buttonColor}`}
                >
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              ...
              <h3 className="font-medium text-gray-900 mb-2">Create Pages</h3>
            ...
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              ...
              <h3 className="font-medium text-gray-900 mb-2">Add Content</h3>
              <p className="text-sm text-gray-600">
            ...
            <div className="text-center p-4 border border-gray-200 rounded-lg">
              ...
              <h3 className="font-medium text-gray-900 mb-2">Launch</h3>
              <p className="text-sm text-gray-600">
